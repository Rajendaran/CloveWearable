...
public interface ICoveConstant {
	...
	public static final String GET_ALL_TEMP_QUERY = "FROM Temperature";
	...
	public static final String BEGINS_OWM_DAO_UPDATETEMP_EVERY_MINUTE_METHOD = "----------Begins OpenWeatherMapDao => updateTemperatureByEveryMinute method----------";
	public static final String BEGINS_OWM_SERVICE_UPDATETEMP_EVERY_MINUTE_METHOD = "----------Begins OpenWeatherMapService => updateTemperatureByEveryMinute method----------";
	public static final String BEGINS_OWM_SCHEDULER_UPDATETEMP_EVERY_MINUTE_METHOD = "----------Begins OpenWeatherMapScheduler => updateTemperatureByEveryMinute method----------";
	public static final String BEGINS_OWM_DAO_GETALLTEMP_METHOD = "----------Begins OpenWeatherMapDao => getAllTemperature method----------";
	public static final String BEGINS_OWM_SERVICE_GETALLTEMP_METHOD = "----------Begins OpenWeatherMapService => getAllTemperature method----------";
